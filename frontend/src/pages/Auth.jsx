...
import TurnstileCaptcha, { TURNSTILE_CONFIGURED } from "@/components/TurnstileCaptcha";
...
function friendlyAuthError(error) {
  ...
  if (/captcha|security verification/i.test(message)) {
...
export default function AuthPage() {
  ...
  const onSubmit = async (e) => {
    ...
    if (TURNSTILE_CONFIGURED && !captchaToken) {
