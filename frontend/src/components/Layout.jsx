...
const NAV = [
  ...
  { to: "/indicators", label: "Indicators", icon: ChartNoAxesCombined, testid: "nav-indicators" },
  { to: "/pbm-brain", label: "PBM Brain", icon: BrainCircuit, testid: "nav-pbm-brain" },
  { to: "/admin/users", label: "Users", icon: UserRoundCog, testid: "nav-admin-users", adminOnly: true },
