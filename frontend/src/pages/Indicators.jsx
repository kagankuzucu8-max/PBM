...
import { ChartNoAxesCombined, ExternalLink, Plus, Trash2 } from "lucide-react";
        ...
        <div className="space-y-5">
          {isAdmin && (
            <div className="bg-white border border-zinc-200 rounded-lg overflow-hidden">
              ...
              <form onSubmit={addIndicator} className="p-5 space-y-3" data-testid="indicator-form">
                <input
                  value={form.title}
                ...
                {indicators.map((indicator) => (
                  <li key={indicator.id} className="group">
                    ...
                    >
                      ...
                      {isAdmin && indicator.user_id === user.id && (
                        <span
            ...
            <div>
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between gap-4 mt-5 pt-4 border-t border-zinc-100">
                  <div className="text-xs text-zinc-400">{activeIndicator.author_email || "PBM"}</div>
                  <a
